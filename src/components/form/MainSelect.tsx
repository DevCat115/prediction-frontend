...
export default function MainSelect({ className = '', options, selectedOption, setSelectedOption, ...others }: IProps) {
  ...
  return (
    <div className="relative h-fit" ref={ref}>
      <div
        className={`rounded-md text-gray-100 border border-gray-800 bg-[#212121] px-3 py-2 flex items-center justify-between cursor-pointer ${className}`}
      ...
      {listVisible && (
        <div className="absolute z-50 w-full rounded-md bg-[#212121] border border-gray-800">
